...
function Home() {
  ...
  // Handle token selection and close the dialog
  const handlePayClose = (token) => {
    setSelectedPayToken(token);
    setOpenPay(false); // Close the dialog after selection
  };
    ...
    <div className="w-full md:w-[80%] lg:w-[70%] my-3">
      <div className="px-3">
        ...
        <div className="my-1 space-x-2">
          <span>{selectedPayToken.name}</span>:<span>123</span>
        </div>
      </div>
        ...
        <div className="swap-box p-5">
          ...
          <div className="bg-[#3d3b3b] rounded-lg mt-3 -mb-3 p-4 w-full flex-col xs:flex-row flex">
            <div className="w-full xs:w-1/2">
              <h4 className="text-gray-400 font-semibold text-sm">YOU PAY</h4>
              <div className="">
                <input
                  placeholder="0"
              ...
              <h4 className="text-sm   text-gray-400">50K 100k 250k 1M Max</h4>
            </div>
