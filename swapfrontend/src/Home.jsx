        ...
        <div className="swap-box p-5">
          ...
          <div className="bg-[#3d3b3b] rounded-lg mt-3 -mb-3 p-4 w-full flex-col xs:flex-row flex">
            <div className="w-full xs:w-1/2">
              <h4 className="text-custom-teal font-semibold text-base">
                YOU PAY
              </h4>
              <div className="">
                <input
                  placeholder="0"
                  className="bg-[#3d3b3b]  text-xl my-1 w-[150px]  py-2 rounded focus:outline-none "
                />
              </div>
            ...
            <div className="w-full xs:w-1/2 flex flex-col items-start xs:items-end">
              ...
              <div className="flex text-base text-pink-500 space-x-2">
                <h1>Liq:</h1>
          ...
          <div className="bg-[#3d3b3b] rounded-lg  -mt-3 mb-3 p-4 w-full flex flex-col xs:flex-row">
            <div className=" w-full xs:w-1/2">
              <h3 className="text-custom-teal  text-base font-semibold">
                YOUR RECEIVE
              </h3>
              <h3 className="py-2 text-lg my-1 font-semibold">0</h3>
              <h3 className="text-base  text-green-400">
                {" "}
            ...
            <div className="w-full xs:w-1/2  flex-col flex items-start xs:items-end">
              ...
              <div>
                <h3 className="text-base text-pink-500 flex space-x-2">
                  <h3>Liq:</h3>
                  <h3>{selectedToken2?.liquidity}</h3>
                </h3>
              </div>
            </div>
          </div>
          ...
          <div className="w-full">
            <button className="bg-custom-teal hover:bg-hover-teal p-3 font-semibold rounded-lg bg-[]  text-base w-full md:w-full space-x-3">
              <span>Swap</span>
              <SwapHorizIcon />
            </button>
          </div>
